...
public class AdminBizTest {
    ...
    // admin-client
    private static String addressUrl = "http://127.0.0.1:8002/";
    ...
    public void registry() throws Exception {
        ...
        RegistryParam registryParam = new RegistryParam("xxl-job-executor-sample", "xxl-job-executor-example111", "127.0.0.1:9999");
